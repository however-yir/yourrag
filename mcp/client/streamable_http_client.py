...
async def main():
    try:
        ...
        # async with streamablehttp_client("http://localhost:9382/mcp/", headers={"api_key": "yourrag-fixS-TicrohljzFkeLLWIaVhW7XlXPXIUW5solFor6o"}) as (read_stream, write_stream, _):
        # Or follow the requirements of OAuth 2.1 Section 5 with Authorization header
        # async with streamablehttp_client("http://localhost:9382/mcp/", headers={"Authorization": "Bearer yourrag-fixS-TicrohljzFkeLLWIaVhW7XlXPXIUW5solFor6o"}) as (read_stream, write_stream, _):
