...
async def main():
    try:
        ...
        # async with sse_client("http://localhost:9382/sse", headers={"api_key": "yourrag-IyMGI1ZDhjMTA2ZTExZjBiYTMyMGQ4Zm"}) as streams:
        # Or follow the requirements of OAuth 2.1 Section 5 with Authorization header
        # async with sse_client("http://localhost:9382/sse", headers={"Authorization": "Bearer yourrag-IyMGI1ZDhjMTA2ZTExZjBiYTMyMGQ4Zm"}) as streams:
