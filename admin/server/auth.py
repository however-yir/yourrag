...
DEFAULT_ADMIN_NICKNAME = os.getenv("DEFAULT_SUPERUSER_NICKNAME", "admin")
DEFAULT_ADMIN_EMAIL = os.getenv("DEFAULT_SUPERUSER_EMAIL", "admin@yourrag.local")
DEFAULT_ADMIN_PASSWORD = os.getenv("DEFAULT_SUPERUSER_PASSWORD", "change_me_please")
...
def init_default_admin():
    ...
    if not users:
        default_admin = {
            "id": uuid.uuid1().hex,
            "password": encode_to_base64(DEFAULT_ADMIN_PASSWORD),
