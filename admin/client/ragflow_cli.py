...
class RAGFlowCLI(Cmd):
    def __init__(self):
        ...
        self.account = "admin@yourrag.local"
        self.account_password: str = "change_me_please"
    ...
    def run_interactive(self, args):
        ...
        print("YourRAG command line interface - Type '\\?' for help, '\\q' to quit")
    ...
    def parse_connection_args(self, args: List[str]) -> Dict[str, Any]:
        parser = argparse.ArgumentParser(description="YourRAG CLI Client", add_help=False)
        ...
        parser.add_argument("-w", "--password", default="change_me_please", type=str, help="Superuser password")
        parser.add_argument("-t", "--type", default="admin", type=str, help="CLI mode, admin or user")
        parser.add_argument("-u", "--username", default=None,
                            help="Username (email). In admin mode defaults to admin@yourrag.local, in user mode required.")
